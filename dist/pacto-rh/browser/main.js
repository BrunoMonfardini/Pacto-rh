...
var routes = [
  {
    path: "",
    loadComponent: () => import("./chunk-HIZP5LKU.js").then((m) => m.PublicLayoutComponent),
    children: [
      {
        path: "",
        loadComponent: () => import("./chunk-T3SRGGID.js").then((m) => m.HomeComponent),
        title: "PactoRH \u2014 Treinamento e Desenvolvimento Pessoal"
      },
      {
        path: "empresa",
        loadComponent: () => import("./chunk-QM7L52B5.js").then((m) => m.EmpresaComponent),
        title: "Para Empresas \u2014 PactoRH"
      },
      {
        path: "profissional",
        loadComponent: () => import("./chunk-3KATWWV7.js").then((m) => m.ProfissionalComponent),
        title: "Para Profissionais \u2014 PactoRH"
      },
      {
        path: "disc",
        loadComponent: () => import("./chunk-EEJ4CMFQ.js").then((m) => m.DiscComponent),
        title: "Teste DISC \u2014 PactoRH"
      },
      {
        path: "sobre",
        loadComponent: () => import("./chunk-EEC42KG3.js").then((m) => m.AboutComponent),
        title: "Sobre \u2014 PactoRH"
      },
      {
        path: "contato",
        loadComponent: () => import("./chunk-SOFFC3S7.js").then((m) => m.ContactComponent),
        title: "Contato \u2014 PactoRH"
      },
      {
        path: "blog",
        loadComponent: () => import("./chunk-6KPTFBKT.js").then((m) => m.BlogListComponent),
        title: "Blog \u2014 PactoRH"
      },
      {
        path: "blog/:slug",
        loadComponent: () => import("./chunk-WAX43GKC.js").then((m) => m.BlogDetailComponent),
        title: "Blog \u2014 PactoRH"
      }
    ]
  },
